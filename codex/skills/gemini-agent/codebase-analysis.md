...
These examples assume the `gemini` CLI. If you use a different large-context tool, translate the flags and file-inclusion syntax accordingly.

Leverage a large-context model (Gemini supports ~1M tokens) for comprehensive code analysis.
